...
function installWin32 () {
  ...
  var iconPath = path.join(process.resourcesPath, 'app.asar.unpacked', 'static', 'Torrent-PlayerFile.ico')

  registerProtocolHandlerWin32('magnet', 'URL:BitTorrent Magnet URL', iconPath, process.execPath)
  registerFileHandlerWin32('.torrent', 'io.Torrent-Player.torrent', 'BitTorrent Document', iconPath, process.execPath)
...
function uninstallWin32 () {
  ...
  unregisterFileHandlerWin32('.torrent', 'io.Torrent-Player.torrent', process.execPath)
...
function installLinux () {
  ...
  function installDesktopFile () {
    var templatePath = path.join(config.STATIC_PATH, 'linux', 'Torrent-Player.desktop')
  ...
  function installIconFile () {
    var iconStaticPath = path.join(config.STATIC_PATH, 'Torrent-Player.png')
